...
map.attributionControl.addAttribution('&copy Weather Weather Warning&QuakeMap┃Version : 4.0');
//地図に表示させる上下の順番
...
async function QuakeSelect(num) {
    ...
    var infoHTML = `
      <div class="eq-maxscale">
        最大震度 <img src="${hantei_icon(maxInt_data)}" class="eq-maxscale-icon"></div>
...
function hantei_icon(param) {//震度アイコン
    let kaerichi = param == 10 ? "source/jqk_int10.png" : param == 20 ? "source/jqk_int20.png" : param == 30 ? "source/jqk_int30.png" : param == 40 ? "source/jqk_int40.png" :
    param == 45 ? "source/jqk_int50.png" : param == 46 ? "source/jqk_int_.png" : param == 50 ? "source/jqk_int55.png" : param == 55 ? "source/jqk_int60.png" :
    param == 60 ? "source/jqk_int65.png" : param == 70 ? "source/jqk_int70.png" : "source/jqk_int_.png";
    return kaerichi;
}
